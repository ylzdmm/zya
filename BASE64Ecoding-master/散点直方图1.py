...
#modelname = '/data/tp/data/model/predictor_vae_model_250000_42(qed)(2).h5'
modelname = '/data/tp/data/model/predictor_vae_model_w2v_30_new_250000_42(qed).h5'
...
a = ax2.scatter(x, y, c=pre_out, cmap='YlGnBu', marker='.', s=1)

fig.colorbar(a, ax=ax2)
plt.savefig(fname="picture/predictor_vae_w2v_alldata_latent(qed)(2,3).png",figsize=[5.5,4.5])
#plt.show()
