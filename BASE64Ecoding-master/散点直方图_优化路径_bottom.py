...
optimization_result = open('data/optimization_result_from_bottom_joint_model(5_qed-sas).pkl', 'rb')
...
path0 = data[optimization_result[0][0]][2]
path1 = optimization_result[0][1]
print(data[optimization_result[0][0]][1])
...
x_latent.append(path0[0])
x_latent.append(path1[0])
print(x_latent[0])
print(path0)
